            ...
            <v-card>
                ...
                <v-card-text>
                    <v-container>
                        ...
                        <v-select v-if="formTitle == 'Ubah'" :items="statusMobil" v-model="form.status_mobil" label="Status Mobil" item-value="value" item-text="text" required>
                        </v-select>
                    </v-container>
                </v-card-text>
                <v-card-actions>
        ...
        data() {
            return {
                ...
                statusMobil: [
                    ...
                    {value: "Sedang Dipinjam", text: "Sedang Dipinjam"},
                ],
                image: [],
                imageUrl: '',
        ...
        methods: {
            ...
            updateCar(selected){
                if(selected.length != 0){
                    ...
                    this.form = {
                        ...
                        status_mobil: this.selected[0].status_mobil,
                    },
                    this.dialog = true;
            ...
            save() {
                if(this.formTitle == 'Tambah'){
                    ...
                    newCar.append('status_mobil', this.form.status_mobil);
